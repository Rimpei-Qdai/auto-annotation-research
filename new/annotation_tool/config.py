...
- 画像5で前進距離と全体の曲がりを見てください
- 画像6で左か右かの符号と曲率を見てください
- 赤線が基準にほぼ沿い、横ずれが小さいなら直線系 A に近いです
- 赤線が明確に左右へ曲がる、または極端に短いなら直線系以外 N を選んでください
- 画像1-4は道路や交差点文脈の確認だけに使ってください
...
【見る順番】
- まず画像5と画像6を見てください
- 画像6で左へ明確に曲がるなら B、右へ明確に曲がるなら C を優先してください
- 画像5で前進距離が極端に短い、またはほとんど動いていないなら D を選んでください
- 左右が弱く、極短でもない場合は画像1-4の道路文脈で最も自然な方を選んでください
