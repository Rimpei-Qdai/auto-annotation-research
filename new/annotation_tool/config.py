...
PROMPT_VERSION = "summary_v2_prompt_focus"
...
- まず画像5と画像6だけで判断してください。画像1-4は確認用です
- 緑線は直進基準、赤線は今後3秒間の予測軌道です
- 画像5と画像6の両方で赤線が極端に短い、またはほとんど前進していないなら D を選んでください
- それ以外では、まず左右方向を見てください
- 画像6で赤線の終点が緑線より左に明確に寄り、軌道全体も左へ曲がるなら B です
- 画像6で赤線の終点が緑線より右に明確に寄り、軌道全体も右へ曲がるなら C です
- B と C で迷ったら、画像5でも終点が左なら B、右なら C にしてください
- 右向きの証拠が少しでも優勢なら C を選んでください。左へ固定しないでください
