...
def log_prediction_trace(
    ...
    append_inference_trace({
        ...
        "timestamp_prompt_text": details.get("timestamp_prompt_text"),
        "timestamp_generated_text": details.get("timestamp_generated_text"),
        "structured_prompt_text": details.get("structured_prompt_text"),
        "structured_generated_text": details.get("structured_generated_text"),
        "target_timestamp_text": details.get("target_timestamp_text"),
        "parsed_direction": details.get("parsed_direction"),
        "parsed_speed_state": details.get("parsed_speed_state"),
        "parsed_maneuver": details.get("parsed_maneuver"),
        ...
        "target_center_time_seconds": details.get("target_center_time_seconds"),
        "target_seconds_in_clip": details.get("target_seconds_in_clip"),
